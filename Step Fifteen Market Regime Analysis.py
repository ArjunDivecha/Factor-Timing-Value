...
INPUT FILES:
- /Users/macbook2024/Dropbox/AAA Backup/A Complete/T2 Factor Timing/T2_Optimized_Country_Weights.xlsx:
...
- /Users/macbook2024/Dropbox/AAA Backup/A Complete/T2 Factor Timing/T2_Top_20_Exposure.csv:
  Individual factor exposures for detailed regime analysis

OUTPUT FILES:
- /Users/macbook2024/Dropbox/AAA Backup/A Complete/T2 Factor Timing/T2_Market_Regime_Analysis.xlsx:
  Comprehensive market regime performance analysis
- /Users/macbook2024/Dropbox/AAA Backup/A Complete/T2 Factor Timing/T2_Market_Regime_Performance.pdf:
  Performance visualization by market regime
- /Users/macbook2024/Dropbox/AAA Backup/A Complete/T2 Factor Timing/T2_Regime_Factor_Analysis.pdf:
  Factor exposure analysis by performance regime
...
DESCRIPTION:
Analyzes the optimized T2 strategy performance across different MARKET CONDITION regimes,
...
def load_data():
    ...
    returns_file = '/Users/macbook2024/Dropbox/AAA Backup/A Complete/T2 Factor Timing/T2_Optimized_Country_Weights.xlsx'
    ...
    exposure_file = '/Users/macbook2024/Dropbox/AAA Backup/A Complete/T2 Factor Timing/T2_Top_20_Exposure.csv'
...
def create_market_regime_visualizations(regime_df, performance_stats, factor_analysis):
    ...
    # Save visualization
    output_file = '/Users/macbook2024/Dropbox/AAA Backup/A Complete/T2 Factor Timing/T2_Market_Condition_Analysis.pdf'
...
def save_market_regime_results(regime_df, performance_stats, factor_analysis):
    ...
    Args:
        ...
        factor_analysis: Factor analysis by regime
    """
    output_file = '/Users/macbook2024/Dropbox/AAA Backup/A Complete/T2 Factor Timing/T2_Market_Condition_Analysis.xlsx'
...
def save_regime_analysis_results(regime_df, regime_factor_stats, factor_summary, temporal_analysis):
    ...
    """
    output_file = '/Users/macbook2024/Dropbox/AAA Backup/A Complete/T2 Factor Timing/T2_Market_Regime_Analysis.xlsx'
